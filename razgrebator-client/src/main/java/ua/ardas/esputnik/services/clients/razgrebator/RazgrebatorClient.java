...
public class RazgrebatorClient {
    ...
    public void processUnsubscribed(int orgId, int contactId, Integer messageInstanceId, Long imId, String feedback, Integer contentPartId) throws InterruptedException {
        ComplaintInfo ir = new ComplaintInfo();
        ir.setMessageInstanceId(messageInstanceId);
        ir.setContactId(contactId);
        ir.setReason(feedback);
